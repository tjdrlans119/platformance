            ...
            <ul class="navbar-nav navbar-nav-hover align-items-lg-center">
                <base-dropdown class="nav-item" menu-classes="dropdown-menu-xl">
                    <a slot="title" href="#" class="nav-link" data-toggle="dropdown" role="button">
                        ...
                        <span class="nav-link-inner--text">소개</span>
                    </a>
                        ...
                        <a href="https://demos.creative-tim.com/vue-argon-design-system/documentation/"
                           class="media d-flex align-items-center">
                            ...
                            <div class="media-body ml-3">
                                <h6 class="heading text-primary mb-md-1">우리는</h6>
                                <p class="description d-none d-md-inline-block mb-0">디비패드를 만든이들의 원동력이란?</p>
                            </div>
                        </a>
                        <a href="https://demos.creative-tim.com/vue-argon-design-system/documentation/"
                           class="media d-flex align-items-center">
                            ...
                            <div class="media-body ml-3">
                                <h5 class="heading text-warning mb-md-1">이거슬</h5>
                                <p class="description d-none d-md-inline-block mb-0">어따쓰는고</p>
                            </div>
                        </a>
                    </div>
                </base-dropdown>
